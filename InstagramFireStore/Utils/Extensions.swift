...
extension UIButton {
    func attributedTitle(firstPart: String, secondPart: String) {
        let normalAttributes: [NSAttributedString.Key: Any] = [.foregroundColor: UIColor(white: 1, alpha: 0.87), .font: UIFont.systemFont(ofSize: 16)]
        let attributedTitle = NSMutableAttributedString(string: "\(firstPart) ", attributes: normalAttributes)
